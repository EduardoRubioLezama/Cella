...
public class UnidadmaterialJpaController implements Serializable {
    ...
    public List<Unidadmaterial> findUnidadmaterialByNombre(){
        List<Unidadmaterial> materiales = new ArrayList<>();
        EntityManager em = getEntityManager();
        Query q;
        q = em.createNamedQuery("Unidadmaterial.findAll",Unidadmaterial.class);
        List<Unidadmaterial> unidadmaterial= q.getResultList();
        for (Unidadmaterial a :unidadmaterial){
            materiales.add(a);
        }
        return materiales;
    ...
    public boolean findUnidadmaterialByNombre(String nombre) {
        EntityManager em = getEntityManager();
        Query q = em.createNamedQuery("Unidadmaterial.findByNombrematerial")                
